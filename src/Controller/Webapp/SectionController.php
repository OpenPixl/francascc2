...
class SectionController extends AbstractController
{
     ...
     * @Route("/", name="webapp_section_index", methods={"GET"})
     */
    ...
    /**
     * Ajoute une section
     * @Route("/new", name="webapp_section_new", methods={"GET","POST"})
     */
     ...
     * @Route("/{id}", name="op_webapp_section_show", methods={"GET"})
     */
     ...
     * @Route("/{id}/edit", name="webapp_section_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="webapp_section_delete", methods={"DELETE"})
     */
